...
\#3 and #4 are invalid but are allowed by the type system, indicating this is not a good type to model the data<SideNote id="golang-errors">This is how Go models errors, which is incorrect</SideNote>.
